...
const OPEN_IN_VISION_PDF = document.getElementById('open-in-vision-pdf') as HTMLAnchorElement
...
function hideOpenInVisionPDF(): void {
  OPEN_IN_VISION_PDF.classList.add(HIDDEN)
}

function hideNonOpenInVisionPDF(): void {
